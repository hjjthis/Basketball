...
public class PlayerLinshi  extends BmobObject implements Parcelable {
    private int num;
    private String name;
    ...
    protected PlayerLinshi(Parcel in) {
        num = in.readInt();
        name = in.readString();
        score = in.readInt();
        isTeamA = in.readInt();
    ...
    public PlayerLinshi(int num, String name) {
        this.num = num;
        this.name = name;
    }

    public PlayerLinshi(int isTeamA) {
    ...
    public PlayerLinshi(int num, String name, int score, int isTeamA) {
        this.num = num;
        this.name = name;
        this.score = score;
        this.isTeamA = isTeamA;
    ...
    public PlayerLinshi(int num, String name, int isTeamA) {
        this.num = num;
        this.name = name;
        this.isTeamA = isTeamA;
    }
